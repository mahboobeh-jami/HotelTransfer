            ...
            if (document.querySelector(".train-captcha-content")) {
                if (document.querySelector(".train-captchatxt").value == "") {
                    ...
                    if (!document.querySelector(".train-captcha-content").querySelector(".description")) {
                        document.querySelector(".train-captcha-content").insertAdjacentHTML('beforeend', `<div class="description">Please enter the security code.</div>`);
                    }
                } else {
                    if (document.querySelector(".train-captcha-content").querySelector(".description")) {
                    ...
                    if (isVerify) {
                        ...
                        if (document.querySelector(".services-info-content")) {
                            if (document.querySelector(".serviceid")) {
                                ...
                                console.log("check_provider0", check_provider)
                                if (check_provider == 82 || check_provider == 114) {
                                   ...
                                   if (document.querySelector(".main-container").getAttribute("data-schemaid") == 290251) {
                                    show_insurance_content(element);
                                                                    ...
                                                                    console.log("check_provider2", check_provider)
                                ...
                                console.log("check_provider1", check_provider)
